...
export class ApprovalController {
  ...
  @Get('instances/leadership-summary') @RequirePermission('approvals:read') getLeadershipSummary(@Req() req: any) { return this.proxy.forward(APPROVAL_URL(), 'GET', '/instances/leadership-summary', undefined, hdrs(req)); }
  @Get('instances/organization') @RequirePermission('approvals:read') getOrganizationScoped(@Req() req: any, @Query() q: any) { return this.proxy.forward(APPROVAL_URL(), 'GET', '/instances/organization', undefined, hdrs(req), q); }
