...
export class ProcessController {
  ...
  @Post('definitions/:id/validate')  @RequirePermission('processes:design') validate(@Req() req: any, @Param('id') id: string, @Body() b: any) { return this.proxy.forward(BPM_URL(), 'POST', `/definitions/${id}/validate`, b, hdrs(req)); }
